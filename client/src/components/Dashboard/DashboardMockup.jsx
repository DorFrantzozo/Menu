...
const DashboardMockup = () => {
  return (
    <div
      dir="rtl"
      className="bg-white rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.12)] border border-zinc-100 p-6 w-full max-w-4xl mx-auto flex flex-col font-sans relative overflow-hidden"
    >
      ...
      <div className="flex items-center justify-between mb-6 relative z-10">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-2xl bg-emerald-50 flex items-center justify-center text-2xl shadow-sm">
            👋
          </div>
          <div>
            <h2 className="text-zinc-900 font-extrabold text-lg tracking-tight leading-tight">
              ברוך שובך, Dor!
            </h2>
            <p className="text-zinc-400 text-xs font-medium">
              נהל את התפריט שלך, עקוב אחר סריקות ובצע אופטימיזציה לסועדים.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 relative z-10">
        ...
        <div className="bg-white border border-zinc-100 p-4 rounded-[2rem] shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-zinc-400 text-[9px] font-bold mb-0.5 uppercase tracking-wider">
            סריקות QR
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative z-10 mb-6">
        ...
        <div className="md:col-span-3 bg-white border border-zinc-100 rounded-[2rem] p-5 shadow-sm">
          <h3 className="text-zinc-900 font-extrabold text-sm mb-6 flex justify-between items-center">
            סה"כ כניסות לתפריט
            <span className="text-[9px] text-emerald-500 font-black px-2 py-0.5 bg-emerald-50 rounded-lg">
              +12% השבוע
            </span>
          </h3>
          <div className="h-32 relative">
            ...
            >
              ...
              />
              <path
                d="M0,85 L40,84 L80,88 L120,70 L160,78 L200,45 L240,58 L280,25 L320,38 L360,12 L400,18 V100 H0 Z"
        ...
        <div className="md:col-span-2 flex flex-col">
          <div className="bg-white border border-zinc-100 rounded-[2rem] p-5 shadow-sm flex-1">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="text-[9px] font-black text-emerald-600 hover:underline">
                נהל הכל
              </button>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-zinc-50 overflow-hidden border border-zinc-100">
                  <img
                    src="https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=100&h=100&fit=crop"
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-zinc-50 overflow-hidden border border-zinc-100">
                  <img
                    src="https://images.unsplash.com/photo-1553621042-f6e147245754?w=100&h=100&fit=crop"
                    className="w-full h-full object-cover opacity-80"
                  />
                </div>
                <div className="flex-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] text-zinc-400">
                הורד או שתף את קוד ה-QR.
              </p>
            </div>
          </div>
          <div className="flex gap-2">
            <button className="px-3 py-1.5 bg-white rounded-lg border border-zinc-200 text-[10px] font-bold hover:bg-zinc-50">
              שיתוף
            </button>
            <button className="px-3 py-1.5 bg-zinc-900 text-white rounded-lg text-[10px] font-bold hover:bg-zinc-800">
              הורדה
            </button>
          </div>
        </div>
