      ...
      >
        ...
        >
          <div className="inline-flex items-center gap-2.5 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100 shadow-sm transition-all hover:scale-105 cursor-default">
            ...
            <span className="text-emerald-700 text-[10px] lg:text-[11px] font-black tracking-widest uppercase">
              הצטרפו למהפכת התפריטים הדיגיטליים
            </span>
          </div>
        </motion.div>
        ...
        {/* Text Area */}
        <div
          className="text-center max-w-4xl mx-auto mb-8 lg:mb-10 px-4 md:px-0"
          dir="rtl"
        >
          <motion.h1
            variants={itemVariants}
          ...
          >
            המערכת המתקדמת ביותר לבניית תפריט דיגיטלי למסעדות. חסכו בעלויות
            הדפסה והגדילו את ממוצע ההזמנות עם תפריט QR מעוצב - בלי אפליקציה ובלי
            לחכות לגרפיקאי.
          </motion.p>
        ...
        >
          ...
          <motion.div className="relative z-0 md:ms-40 lg:ms-48 scale-[0.7] md:scale-[0.8] lg:scale-[0.85] origin-top shadow-2xl rounded-[3rem] overflow-hidden bg-white mt-[-20px] lg:mt-[-40px]">
            <DashboardMockup />
          </motion.div>
          ...
          >
            <div className="bg-zinc-50 rounded-lg p-2 mb-2 overflow-hidden aspect-square flex items-center justify-center">
              <img
                src={LandingQrCode}
                alt="דוגמה של תפריט דיגיטלי לסריקה ב-QR"
                className="w-full h-full object-contain"
              />
            </div>
            <p
              className="text-[10px] lg:text-[11px] font-black text-zinc-900 leading-tight"
              dir="rtl"
            >
              סרקו לצפייה <br /> בתפריט חי
            </p>
          </motion.div>
