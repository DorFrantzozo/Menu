      ...
      <div className="bg-white h-full w-full overflow-y-auto overflow-x-hidden flex flex-col">
        ...
        <div className="pt-10 pb-4 px-6 border-b border-zinc-50">
          ...
          <div className="flex gap-2 justify-center mt-4 overflow-x-auto no-scrollbar py-2">
            {["הכל", "ראשונות", "סושי פרימיום", "שתייה"].map((cat, i) => (
              <span
                key={i}
                className={`text-[10px] whitespace-nowrap px-4 py-1.5 rounded-full font-bold transition-all ${i === 2 ? "bg-zinc-900 text-white" : "bg-zinc-100 text-zinc-400"}`}
              >
                {cat}
              </span>
            ))}
        ...
        <div className="p-6">
          ...
          <div className="space-y-6" dir="rtl">
            <div>
              <h3 className="text-xs font-black text-zinc-400 mb-4 tracking-widest uppercase">
                סושי פרימיום
              </h3>
              <div className="space-y-4">
                <div className="flex gap-4 items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-zinc-400 leading-tight mt-1 ml-4">
                      אבוקדו, פטריות שיטאקי במרינדה, איולי כמהין ושבבי בטטה
                    </p>
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-zinc-400 leading-tight mt-1 ml-4">
                      רולים נבחרים (דגים וצמחוני) המוגשים בסירת עץ מסורתית.
                      השילוב המדויק בין דגים טריים, ירקות פריכים ורטבים מהמזרח
                      פריך
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-auto p-6 bg-zinc-50 border-t border-zinc-100">
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-zinc-100 flex flex-col items-center">
            <p className="text-[10px] font-bold text-zinc-400 mb-2 underline tracking-widest uppercase">
              סרוק אותי
            </p>
            <div className="w-12 h-12 bg-zinc-200 p-2 rounded-lg flex items-center justify-center text-white text-xl shadow-lg">
              <img
                src={LandingQrCode}
                alt="QR Code"
                className="hover:scale-105 transition duration-15"
              />
            </div>
          </div>
        </div>
