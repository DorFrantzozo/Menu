      ...
      <footer className=" bg-black text-center text-neutral-600 dark:bg-black dark:text-neutral-200 lg:text-left">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-end">
          ...
          <div className="flex justify-center">
            <a href="/" className="mr-6 text-neutral-00 dark:text-neutral-200">
              {" "}
              <svg
            ...
            <button className="text-neutral-600 dark:text-neutral-200 hover:text-neutral-400 hover:scale-150 transform duration-500">
              <a href="https://github.com/DorFrantzozo">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4"
                  fill="currentColor"
            ...
            <div className="">
              ...
              <p className="mb-4">
                <a
                  ...
                  className="text-neutral-600 dark:text-neutral-200 hover:text-white cursor-pointer"
                >
                  התחברות
                </a>
              </p>
